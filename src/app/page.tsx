...
export default async function Home() {
  ...
  return <Shell content={c}>
    <section className="home-hero" id="home"><div className="container"><p className="eyebrow">ARTA PARTNERS — STRATEGIC BRAND PARTNER</p><h1>{c.heroTitle}</h1><div className="hero-bottom"><p className="hero-description">{c.heroDescription}</p><div className="hero-actions"><a className="hero-cta" href="/business-checkup/">Bedah Bisnis Anda <span aria-hidden="true">↗</span></a><TextLink href="/our-brands/">Jelajahi Brand Kami</TextLink></div></div></div></section>
